  ...
  return (
    <section className={cn("relative overflow-hidden bg-navy py-24 md:py-32", className)}>
      <div>
        ...
        <div className="pointer-events-none absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-navy" />
        <div className="pointer-events-none absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-navy" />
      </div>
    </section>
  );
};
